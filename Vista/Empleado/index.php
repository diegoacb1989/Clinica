    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Empleado de sede</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" class="opcion" href="./Paciente/index.php">pacientes</a>
                        <a class="collapse-item" class="opcion" href="./Citas/index.php">Gestión de citas médicas</a>
                        <a class="collapse-item" class="opcion" href="./Citas/index.php?tipo=medica">médicos y cirugía</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" class="opcion" href="./Proveedor/index.php">Proveedor</a>
                        <a class="collapse-item" class="opcion" href="./Producto/index.php">Productos</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="./Medico/index.php">Medico</a>              
                    </div>
                </div>
            </li>
