        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" class="opcion" href="./Director/index.php">Director de sedes</a>
                        <a class="collapse-item" class="opcion" href="./Asesores/index.php">Asesores de afiliaciónes</a>
                        <a class="collapse-item" class="opcion" href="./Gerente/index.php">Gerente de sedes</a>
                        <a class="collapse-item" class="opcion" href="./Cliente/index.php">Clientes</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="./Pais/index.php">pais</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="./Ciudad/index.php">Ciudad</a>              
                    </div>
                </div>
            </li>

            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collageSedes"
                    aria-expanded="true" aria-controls="collageSedes">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Sedes</span>
                </a>
                <div id="collageSedes" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="./Sede/index.php">Gestion de sedes</a>              
                    </div>
                </div>
            </li>
             <div class="sidebar-heading">
            ...
            <!-- Nav Item - Tables -->
             <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collageExp"
                    aria-expanded="true" aria-controls="collageExp">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Exportar</span>
                </a>
                <div id="collageExp" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="./PDF/index.php">PDF</a>   
                        <a class="collapse-item" href="">CSV</a>    
                        <a class="collapse-item" href="">EXCEL</a>        
                    </div>
                </div>
            </li>
            <!-- Divider -->
